...
export function Details(){
    return(
        <VStack gap={5}  w={'full'} h={'100vh'} align={'center'} justify={'center'}>
            <Text textAlign={{base:'center',md:'left'}} fontSize={{base: '3xl', md: '7xl'}} css={{fontFamily: 'Sacramento', color: 'blue.400'}} >Você está convidado para celebrar conosco o dia mais feliz de nossas vidas!</Text>
            <VStack w={'full'} gap={10}>
                <VStack fontFamily={'Sour Gummy'}>
                 ...
                 <HStack gap={4}>
                    <VStack gap={4}>
                        <Text textAlign={'center'} css={{fontFamily: 'Sacramento', fontWeight: 'bold',color: 'blue.400',}} fontSize={{base: '2xl', md: '7xl'}}>Cerimônia</Text>
                    ...
                    <VStack gap={0}>
                        <Text textAlign={'center'} css={{fontFamily: 'Sacramento',fontWeight: 'bold' ,color: 'blue.400',}} fontSize={{base: '2xl', md: '7xl'}}>Almoço</Text>
                        <Text textAlign={'center'} css={{fontFamily: 'Sacramento',fontWeight: 'bold' , color: 'blue.400',}} fontSize={{base: 'xl', md: '4xl'}}>(local com piscina)</Text>
